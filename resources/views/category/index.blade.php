    ...
    <table class="table">
        ...
        @foreach($listCategories as $listCategory)
            <tr>
                ...
                <td>
                    {!! link_to_route('admin.categories.show', 'View Category', [$listCategory->id], ['class' => 'btn btn-info']) !!}
                    {!! link_to_route('admin.categories.edit', 'Edit Category', [$listCategory->id], ['class' => 'btn btn-primary']) !!}
